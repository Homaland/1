...
import { arbitrum, ethereum, polygon, scroll, optimism, mainnet, solana } from '@reown/appkit/networks'
...
createAppKit({
  ...
  networks: [arbitrum, ethereum, polygon, scroll, optimism, mainnet, solana],
  metadata: metadata,
  projectId,
  features: {
